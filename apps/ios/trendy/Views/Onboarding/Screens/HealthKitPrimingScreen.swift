//
//  HealthKitPrimingScreen.swift
//  trendy
//
//  Pre-permission priming screen for HealthKit permission
//

import SwiftUI
import UIKit

/// A full-screen priming view that explains the benefits of HealthKit permissions
...
struct HealthKitPrimingScreen: View {
    ...
    private let permissionType = OnboardingPermissionType.healthkit
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 16) {
                ...
                .accessibilityHint("Shows iOS permission dialog. Allows importing workouts and health data.")
                ...
                .accessibilityLabel("Skip health access")
                .accessibilityHint("You can connect health data later in Settings.")
