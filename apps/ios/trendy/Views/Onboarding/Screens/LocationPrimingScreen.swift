    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 16) {
                ...
                .accessibilityHint("Shows iOS permission dialog. Allows automatic event logging at places you visit.")
                ...
                .accessibilityHint("You can enable location tracking later in Settings.")
