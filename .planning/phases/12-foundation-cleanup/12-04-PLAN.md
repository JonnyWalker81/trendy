...
must_haves:
  truths:
    - "Zero print() statements in the 8 UI view modules listed in files_modified"
    - "All logging in these files uses structured Log.* categories"
  ...
  note: >
    ...
    and use structured logging. This plan addresses 39 print() statements in peripheral UI view files.
  artifacts:
